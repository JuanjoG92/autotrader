...
const DEFAULT_WATCHLIST = [
  ...
  { ticker: 'AMD',   instrument_type: 'CEDEARS',  segment: 'C', currency: 'ARS' },
  { ticker: 'NFLX',  instrument_type: 'CEDEARS',  segment: 'C', currency: 'ARS' },
  { ticker: 'DIS',   instrument_type: 'CEDEARS',  segment: 'C', currency: 'ARS' },
  { ticker: 'PYPL',  instrument_type: 'CEDEARS',  segment: 'C', currency: 'ARS' },
  { ticker: 'BABA',  instrument_type: 'CEDEARS',  segment: 'C', currency: 'ARS' },
  { ticker: 'BA',    instrument_type: 'CEDEARS',  segment: 'C', currency: 'ARS' },
  { ticker: 'KO',    instrument_type: 'CEDEARS',  segment: 'C', currency: 'ARS' },
  { ticker: 'JPM',   instrument_type: 'CEDEARS',  segment: 'C', currency: 'ARS' },
  { ticker: 'WMT',   instrument_type: 'CEDEARS',  segment: 'C', currency: 'ARS' },
  { ticker: 'INTC',  instrument_type: 'CEDEARS',  segment: 'C', currency: 'ARS' },
  { ticker: 'UBER',  instrument_type: 'CEDEARS',  segment: 'C', currency: 'ARS' },
  { ticker: 'SNAP',  instrument_type: 'CEDEARS',  segment: 'C', currency: 'ARS' },
  { ticker: 'SHOP',  instrument_type: 'CEDEARS',  segment: 'C', currency: 'ARS' },
  { ticker: 'HOOD',  instrument_type: 'CEDEARS',  segment: 'C', currency: 'ARS' },
  { ticker: 'BIOX',  instrument_type: 'CEDEARS',  segment: 'C', currency: 'ARS' },
  { ticker: 'GLOB',  instrument_type: 'CEDEARS',  segment: 'C', currency: 'ARS' },
  { ticker: 'JMIA',  instrument_type: 'CEDEARS',  segment: 'C', currency: 'ARS' },
  { ticker: 'MU',    instrument_type: 'CEDEARS',  segment: 'C', currency: 'ARS' },
  // ── CEDEARs Energía ──
